...
<div class="profile">
    ...
    <br><a href="<?php echo site_url('tickets/ticketlist'); ?>" title="Zur&uuml;ck zur Ticketliste" style="font-weight: bold;">&lt; Zur&uuml;ck zur Ticketliste</a><br>
    <h2 class="page-title">Ticket #<?php echo $ticket->ticketID; ?></h2>
    ...
    <div id="reply">
        ...
        <?php echo form_open('tickets/ticket-'.$ticket->ticketID.'/reply'); ?>
            <label for="message">Nachricht:</label>
            <textarea name="message" cols="52" rows="5" id="contentTA"><?php echo set_value('message'); ?></textarea><br>
